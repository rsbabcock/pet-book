# Generated by Django 2.1.1 on 2018-09-04 21:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='petBookApi.Note')),
                ('pets', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='petBookApi.Pet')),
            ],
        ),
        migrations.CreateModel(
            name='PetType',
